import { c as createAstro, a as createComponent, r as renderTemplate, m as maybeRenderHead, b as addAttribute, d as renderComponent } from './astro/server_CMoSAYMB.mjs';
import 'kleur/colors';
import { $ as $$Icon } from './MainLayout_47Z95a1F.mjs';
...
const $$PrimaryCTA = createComponent(($$result, $$props, $$slots) => {
  ...
  const bgColorClasses = "bg-emerald-500 hover:bg-emerald-400 active:bg-emerald-500 dark:focus:outline-none";
...
}, "C:/Users/Alex_/Desktop/Repos/MULTIPLA/multipla/src/components/ui/buttons/PrimaryCTA.astro", void 0);
